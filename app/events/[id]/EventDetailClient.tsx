...
type EventRecord = (typeof pastEvents)[number];
  ...
  if (!event) {
    return (
      ...
      >
        ...
        <button
          onClick={() => router.back()}
          className="px-6 py-3 rounded-full transition-all glass glass-hover border border-[var(--border-primary)] hover:border-[var(--accent-blue)] hover:text-[var(--text-accent)] hover:shadow-[0_0_14px_var(--accent-glow-strong)]"
        >
          Return to Hub
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <Link
          href="/events"
          className="group inline-flex items-center transition-all duration-300 mb-12 font-mono text-sm uppercase tracking-widest"
          style={{ color: "var(--text-muted)" }}
        >
          <span
            className="mr-3 h-px w-8 bg-[var(--border-primary)] transition-all duration-300 group-hover:w-12 group-hover:bg-[var(--accent-blue)] group-hover:shadow-[0_0_14px_var(--accent-glow-strong)]"
          />
          <ArrowLeft className="w-4 h-4 mr-2 transition-colors group-hover:text-[var(--text-accent)]" />
          <span className="transition-colors group-hover:text-[var(--text-accent)] group-hover:drop-shadow-[0_0_10px_var(--accent-glow-strong)]">
            Back to Matrix
          </span>
        </Link>
